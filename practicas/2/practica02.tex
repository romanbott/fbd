...
% ==========================================
\newcommand{\documentoTitulo}{Practica 02}
\newcommand{\documentoSubtitulo}{Sistema de Archivos vs. Bases de Datos}
...
\begin{enumerate}[label=\alph*., leftmargin=*]
	\input{respuestas/requerimientosCandidato.tex}
	\input{respuestas/contexSistema.tex}
	\input{respuestas/requerimientosFuncionales.tex}
        \input{respuestas/requerimientosNoFuncionales.tex}
\end{enumerate}
